...
DROP PROCEDURE SP_CREATE_TABLE_DEPARTMENT;
...
-- TO CALL ALL THE PROCEDUTE --
DELIMITER //
CREATE PROCEDURE SP_CALLING_ALL_CREATE_TABLES_SP()
BEGIN
CALL SP_CREATE_TABLE_BANK_BRANCH;
CALL SP_CREATE_TABLE_EMPLOYEE;
CALL SP_CREATE_TABLE_DEPARTMENT;
...
DELIMITER ;
 ...
 -- CALL PRO -- 
 CALL SP_CALLING_ALL_CREATE_TABLES_SP;
 
 -- CREATE TABLE DATA_MAINTAINANCE --
 DELIMITER //
 CREATE PROCEDURE SP_CREATE_TABLE_DATA_MAINTAINANCE()
 BEGIN
 CREATE TABLE DATA_MAINTAINANCE(
